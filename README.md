...
![image](https://github.com/ynn117/0522mHelloWorld/assets/133843571/6a2ff353-68de-41f7-94e9-e68e294477a8)

프로세스 ID는 'ps'명령어를 사용하여 확인 가능, 작업번호는 'jobs' 명령어를 통해 확인 가능

**-프로세스에 특정한 신호를 보내는 명령어**

**-보통 실행중인 프로세스에 종료신호 보냄**
...
| -S | 보낼 시그널을 지정함. (시그널 번호나 시그널 이름을 지정함) |
